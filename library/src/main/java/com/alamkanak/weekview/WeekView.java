...
public class WeekView extends View {
    ...
    private final GestureDetector.SimpleOnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            // Log.d(this.getClass().getName(), "onSingleTapConfirmed: entered");
//            Log.d(this.getClass().getName(), "onSingleTapConfirmed: " +
//                    "\nx = " + e.getX() +
//                    "\ny = " + e.getY() +
//                    "\nmHeaderColumnWidth = " + mHeaderColumnWidth +
//                    "\nmHeaderHeight + mHeaderRowPadding * 2 + mHeaderMarginBottom = " + (mHeaderHeight + mHeaderRowPadding * 2 + mHeaderMarginBottom)+
//                    "\nmHeaderHeight = " +mHeaderHeight +
//                    "\nmHeaderRowPadding = " + mHeaderRowPadding+
//                    "\nmTimeClickListener is null = "+ (mTimeClickListener == null)
//            );
            if (mTimeClickListener != null && e.getX() < mHeaderColumnWidth &&  e.getY() > (mHeaderHeight + mHeaderRowPadding * 2 + mHeaderMarginBottom)) {
                Log.d(this.getClass().getName(), "onSingleTapConfirmed: Clicking a time ");
                mTimeClickListener.onTimeClicked(getTimeFromPoint(e.getX()+mHeaderColumnWidth, e.getY()));
                return super.onSingleTapConfirmed(e);
            }
            return super.onSingleTapConfirmed(e);
        }
    ...
    private void drawTimeColumnAndAxes(Canvas canvas) {
        ...
        for (int i = 0; i < getNumberOfPeriods(); i++) {
            ...
            if (time == null)
                throw new IllegalStateException("A DateTimeInterpreter must not return null time");
            if (top < getHeight())
                canvas.drawText(time + "s", mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
        }
    }
    ...
    public interface TimeClickListener {
         ...
         */
        void onTimeClicked(Calendar dateTime);
